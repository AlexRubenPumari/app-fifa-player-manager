import { validateEditPlayerPayload, type EditPlayerPayload } from "../request-model/edit-player"
...
export async function editPlayer(
  ...
  if (!validateEditPlayerPayload({ player })) throw new Error("Payload is invalid")
